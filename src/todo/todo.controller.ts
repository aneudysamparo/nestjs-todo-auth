...
import { TodoDto } from './models/dto/todo-dto.model';
...
export class TodoController {
    ...
    async create(@Body() params: TodoParams): Promise<TodoDto> {
        try {
            ...
            return this._todoService.map<TodoDto>(newTodo);
        } catch (e) {
    ...
    async get(
        ...
        try {
            ...
            return this._todoService.map<TodoDto[]>(map(todos, todo => todo.toJSON()));
        } catch (e) {
            throw new HttpException(e, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    async update(@Body() vm: TodoDto): Promise<TodoDto> {
        ...
        try {
            ...
            return this._todoService.map<TodoDto>(updated.toJSON());
        } catch (e) {
            throw new HttpException(e, HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    async delete(@Param('id') id: string): Promise<TodoDto> {
        try {
            ...
            return this._todoService.map<TodoDto>(deleted.toJSON());
        } catch (e) {
